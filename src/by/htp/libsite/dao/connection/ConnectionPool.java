...
public final class ConnectionPool {
	...
	private ConnectionPool() {
		this.driverName = ConnectionParameter.DRIVER;
		this.url = ConnectionParameter.URL;
		this.user = ConnectionParameter.USER;
		this.password = ConnectionParameter.PASSWORD;
		this.poolSize = Integer.parseInt(ConnectionParameter.PULL_SIZE);
	}
